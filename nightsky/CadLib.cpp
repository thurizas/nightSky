...
CDxfFileWrite::CDxfFileWrite()
{
	...
	// load CadIO.dll
	hinstCadIO = LoadLibraryA( "CadIO.dll" );
	if( !hinstCadIO )
	{
	...
	result = true;
	result &= ((dxfWriteParamString = (BOOL(*)(HDXF, int, char* ))
	...
	result &= ((dxfCreateFile = (HDXF(*)(const char*))
	...
	result &= ((dxfSetCurrentDimStyle = (BOOL(_cdecl*)(HDXF, char* )) 
	...
	result &= ((dxfText = (BOOL(_cdecl*)( HDXF hDxf, char*  Text, double x1, double y1, double x2, double y2, double Height, double Rotation, DWORD Justification, double WidthFactor, char*  StyleName ))
		GetProcAddress( hinstCadIO, "dxfText" )) != NULL);
	result &= ((dxfDimLinear = (BOOL(_cdecl*)( HDXF, double, double, double, double, double, double, double, char* ))
	...
	result &= ((dxfInsertBlock = (BOOL(_cdecl*)( HDXF hDxf, char*  BlockName, double x, double y, double xScale, double yScale, double Rotation ))
		GetProcAddress( hinstCadIO, "dxfInsertBlock" )) != NULL);

	result &= ((dxfBlockBegin = (BOOL(_cdecl*)( HDXF hDxf, char*  BlockName, char*  LayerName, double bx, double by, char flags ))
...
BOOL CDxfFileWrite::SetCurrentDimStyle( char*  Name )
{
	ISLIBRARYLOADED();
...
BOOL CDxfFileWrite::Text( char*  Text, double x1, double y1, double x2, double y2, double Height, DWORD Justification, double Rotation, double WidthFactor, char*  StyleName )
{
	ISLIBRARYLOADED();
	return dxfText( m_hDxf, Text, x1, y1, x2, y2, Height, Rotation, Justification, WidthFactor, StyleName );
}

BOOL CDxfFileWrite::Text( char*  Text, double x, double y, double Height, double Rotation, double WidthFactor, char*  StyleName )
{
	ISLIBRARYLOADED();
	return dxfText( m_hDxf, Text, x, y, x, y, Height, Rotation, TJ_LEFT, WidthFactor, StyleName );
}

BOOL CDxfFileWrite::DimLinear( double x1, double y1, double x2, double y2, double x3, double y3, double angle, char*  text )
{
	ISLIBRARYLOADED();
...
BOOL CDxfFileWrite::InsertBlock( char*  BlockName, double x, double y, double xScale, double yScale, double Rotation )
{
	ISLIBRARYLOADED();
...
// BLOCKS section --------------------------------------------------
BOOL CDxfFileWrite::BlockBegin( char*  BlockName, char*  LayerName, double bx, double by, char flags )
{
	ISLIBRARYLOADED();
...
// Base Functions --------------------------------------------------
BOOL CDxfFileWrite::WriteParameter( int GroupCode, char*  Value )
{
	ISLIBRARYLOADED();
...
CDrawing::CDrawing()
{
	...
	result &= ((drwDeleteEntity = (BOOL(*)(HDRAWING, char*, OBJHANDLE))
		GetProcAddress( hinstCadIO, "drwDeleteEntity" )) != NULL);
	result &= ((drwChangeEntity = (BOOL(*)(HDRAWING, char*, PENTITYHEADER, LPVOID))
		GetProcAddress( hinstCadIO, "drwChangeEntity" )) != NULL);
	result &= ((drwFindEntity = (OBJHANDLE(*)(HDRAWING, char* , PENTITYHEADER, LPVOID, DWORD))
		GetProcAddress( hinstCadIO, "drwFindEntity" )) != NULL);
	// Datafile dataexchange
	result &= ((drwSaveDataToFile = (BOOL(*)(HDRAWING, DWORD, char* , HWND))
		GetProcAddress( hinstCadIO, "drwSaveDataToFile" )) != NULL);
	result &= ((drwLoadDataFromFile = (BOOL(*)(HDRAWING, OBJHANDLE, DWORD, char* , HWND))
...
// Configuration ---------------------------------------------------
BOOL CDrawing::SetLayer( char* Name )
{
	LAYER Layer;
...
BOOL CDrawing::SetLineType( char* Name )
{
	LTYPE LType;
...
BOOL CDrawing::SetTextStyle( char* Name )
{
	STYLE Style;
...
BOOL CDrawing::SetDimStyle( char* Name )
{
	DIMSTYLE DimStyle;
...
// BLOCKS ----------------------------------------------------------
OBJHANDLE CDrawing::AddBlock( PBLOCKHEADER pBlockHeader, char*  strFileName )
{
	OBJHANDLE	result;
	ISLIBRARYLOADED();
...
BOOL CDrawing::SetActiveBlock( char* strBlockName )
{
	ISLIBRARYLOADED();
...
BOOL CDrawing::DeleteEntity( char* strBlockName, OBJHANDLE EntityObjhandle )
{
	ISLIBRARYLOADED();
	return drwDeleteEntity(m_hDrawing, strBlockName, EntityObjhandle);
}

BOOL CDrawing::ChangeEntity( PENTITYHEADER pEntityHeader, LPVOID pEntityData, char* strBlockName )
{
	ISLIBRARYLOADED();
	return drwChangeEntity(m_hDrawing, strBlockName, pEntityHeader, pEntityData);
}

OBJHANDLE CDrawing::FindEntity( DWORD dwFindType, PENTITYHEADER pEntityHeader, LPVOID pEntityData, char*  strBlockName )
{
	ISLIBRARYLOADED();
...
*/
OBJHANDLE CDrawing::DimLinear( double x1, double y1, double x2, double y2, double x3, double y3, double angle, char* text )
{
...
OBJHANDLE CDrawing::InsertBlock( char*  BlockName, double x, double y, double xScale, double yScale, double Rotation )
{
	BLOCKHEADER BlockHeader;
...
OBJHANDLE CDrawing::Text( char*  Text, double x1, double y1, double x2, double y2, double Height, short Justification, double Rotation, double WidthFactor )
{
	ENTTEXT text;
	text.Point0.x = x1;
	text.Point0.y = y1;
...
OBJHANDLE CDrawing::Text( char*  Text, double x, double y, double Height, double Rotation, double WidthFactor )
{
...
BOOL CDrawing::SaveDXFFile( char*  FileName, HWND hWndProgress )
{
	ISLIBRARYLOADED();
	return drwSaveDataToFile(m_hDrawing, 0, FileName, hWndProgress);
}

BOOL CDrawing::LoadDXFFile( char*  FileName, HWND hWndProgress )
{
	ISLIBRARYLOADED();
